...
MSP.GlobalConnectionsViewGraph.prototype = {
  ...
  generateGlobalConnectionsViewGraph: function () {
    ...
    this.firstGraphDim = {
      width: _SingletonConfig.width - this.firstGraphMargin.right - this.firstGraphMargin.left,
      height: (_SingletonConfig.height * this.graphRatio) - this.firstGraphMargin.top
    ...
    this.scndGraphDim = {
      width: _SingletonConfig.width - this.scndGraphMargin.right - this.scndGraphMargin.left,
      height: (_SingletonConfig.height * this.graphRatio) - this.scndGraphMargin.top - this.scndGraphMargin.bottom
    };
  ...
  updateVisualization: function () {
    ...
    var dataEE = {text: "EE Conn.", textShort: "", max: 0, color: _SingletonConfig.EEColor, data: []};
    var dataEI = {text: "EI  Conn.", textShort: "", max: 0, color: _SingletonConfig.EIColor, data: []};
    var dataIE = {text: "IE  Conn.", textShort: "", max: 0, color: _SingletonConfig.IEColor, data: []};
    var dataII = {text: "II  Conn.", textShort: "", max: 0, color: _SingletonConfig.IIColor, data: []};
    var dataAI = {text: "All E SE.", textShort: "", max: 0, color: _SingletonConfig.EColor, data: []};
    var dataAE = {text: "All I SE.", textShort: "", max: 0, color: _SingletonConfig.IColor, data: []};
  ...
  graph: function (graphID, graphDim, graphMargin, dataArray, graphTitle) {
    ...
    var legendText = legendElements.append("text")
                                   .attr("y",
                                         (graphDim.height * 0.5) - (legendProp.lineHeight * dataArray.length * 0.5))
    ...
    d3.select(".graphs")
      ...
      .on("mousemove", function () {
        ...
        var tooltip = {
          x: d3.mouse(d3.select('body').node())[0] + self.tooltipMarginRatio * _SingletonConfig.width,
          y: d3.mouse(d3.select('body').node())[1] + self.tooltipMarginRatio * _SingletonConfig.height,
