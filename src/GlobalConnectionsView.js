...
MSP.GlobalConnectionsView.prototype = {
  ...
  generateGlobalConnectionsView: function () {
    _SingletonConfig.navBar = [{label: "Bar", viewID: 0, src: "bargraph.png"},
    ...
    this.firstGraphDim = {
      width: (_SingletonConfig.width * this.firstGraphWidthRatio) - this.firstGraphMargin.right
             - this.firstGraphMargin.left,
      height: _SingletonConfig.height - this.firstGraphMargin.top - this.firstGraphMargin.bottom
    };
    this.scndGraphDim = {
      width: (_SingletonConfig.width * this.scndGraphWidthRatio) - this.scndGraphMargin.right
             - this.scndGraphMargin.left,
      height: _SingletonConfig.height - this.scndGraphMargin.top - this.scndGraphMargin.bottom
    };
  ...
  graph: function (graphID, graphTitle, margins, dimensions, dataTypes, histogramData, maxDataValue) {
    ...
    var graphElements = _SingletonConfig.svg.append("g")
                                        .attr("id", "graph" + graphID)
                                        .attr("transform",
                                              "translate(" + margins.cumulativeLeft + "," + margins.top + ")");
