...
MSP.GraphDetailMicroscopicView.prototype = {
  ...
  generateGraph: function () {
    ...
    this.maxCalciumValue = Math.max.apply(Math, _SimulationData.gNeuronsDetails[_SingletonConfig.neuronSelected].Calcium);
  ...
  initGraphs: function () {
    ...
    for (var i = length; i < lIndex + 1; i++) {
      ...
      this.ActData.push({
        ...
        color: this.colorScale(_SimulationData.gNeuronsDetails[_SingletonConfig.neuronSelected].Calcium[i])
      });
