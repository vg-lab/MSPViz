...
MSP.MacroscopicViewElipse = function ()
{
    ...
    var step = 2*Math.PI/100;  // see note 1
    var h = 0;
    var k = 0;
    var r = 1500;
    ...
    { var x = h + r*Math.cos(theta);
        var y = k - 0.47 * r*Math.sin(theta);    //note 2.
        this.posXA.push(x);
        this.posYA.push(y);
    }

    var step = 2*Math.PI/200;  // see note 1
    var h = 0;
    var k = 0;
    var r = 2500;
    ...
    var step = 2*Math.PI/300;  // see note 1
    var h = 0;
    var k = 0;
    var r = 4500;
    ...
    var step = 2*Math.PI/400;  // see note 1
    var h = 0;
    var k = 0;
    var r = 6500;
