...
MSP.SimulationData.prototype = {
  ...
  recalculateScales: function (pColorMin, pColorMax, pColorType) {
    ...
    this.CaIScale = d4.scaleSequential(d4["interpolate" + _SingletonConfig.calciumScheme]).domain([this.minICalciumValue, this.maxICalciumValue]);
    this.CaEScale = d4.scaleSequential(d4["interpolate" + _SingletonConfig.calciumScheme]).domain([this.minECalciumValue, this.maxECalciumValue]);
  },
