...
UI.Visualizer.prototype = {
  ...
  bindUIActions: function (self) {
    ...
    $("#btnAddID").on('click', function (event) {
      ...
      $("#listaCentroElipse").append('<button class="ellipseButton" onclick="delCenter(' + id + ');">' + id + '</button>');
    ...
    $("#btnAddSelected").on('click', function (event) {
      _SimulationFilter.gNeuronsFilter.forEach(function (z) {
        ...
        if (d.selected) {
          d.centerElipse = true;
          $("#listaCentroElipse").append('<button class="ellipseButton" onclick="delCenter(' + d.NId + ');">' + d.NId + '</button>');
        }
      });
      _SimulationController.view.update();
    });
    ...
    $("#btnApplyFilter").on('click', function () {
      ...
      $("#filterList").append('<div class="filter"><div class="filterTitle" style="background-color:' + color + '"><span class="filterTitleText">' + tipoCompleto + '</span><button class="filterButton">X</button> </div>' +
    ...
    $("#comboScaleConnection").on('change', function () {
      ...
      var colorConfig = [_SingletonConfig.EEColor, _SingletonConfig.EIColor, _SingletonConfig.IEColor, _SingletonConfig.IIColor];
  ...
  resize: function () {
    ...
    _SingletonConfig.height = $(window).height() - $("#jqxBottomControls").outerHeight() - $("#colorSampleBand").outerHeight();
